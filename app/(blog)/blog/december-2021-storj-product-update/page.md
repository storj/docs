...
* We've updated the Satellite sidebar navigation to be more intuitive and removed the top bar navigation giving our users a cleaner UI and more screen real estate. [Sign in](https://us1.storj.io/project-dashboard) to check it out!
* We updated the free tier to be one project with 150 GB of storage and 150 GB of egress instead of three projects with 50 GB each. You can always upgrade to a pro account to get higher project, storage, and egress limits. Go Pro today! [Sign up now.](https://us1.storj.io/signup)
* For more information about smaller items we’ve completed in the last month, please look at our changelogs: [v1.42.4](https://forum.storj.io/t/changelog-v1-42-4/15982), [v1.43.1](https://forum.storj.io/t/changelog-v1-43-1/16208), [v1.44.1](https://forum.storj.io/t/changelog-v1-44-1/16287).

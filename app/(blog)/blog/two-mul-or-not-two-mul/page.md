...
optimization rules". I'll test how this optimization affects things by manually replacing
the `x * 19` with `mul19`:
...
usage, which seemed to help as well. And I got these results:
...
Of course the internal details of cores can vary wildly. See more details in [Optimizing C++ by Agner Fog](https://www.agner.org/optimize/optimizing_cpp.pdf).

---
title: Can we use an exchange as a wallet for payouts?
...
---
It is very important to note that an exchange address is not a valid address unless it is of the type that enables you to hold the private key yourself (decentralized exchange). See article [How do I hold USDC? What is a valid address or compatible wallet?](docId:a045be02-e05a-11ef-9338-6045bd1fa4e3)
...
Most of the exchanges use a separate deposit addresses for every token and if you send USDC to a deposit address meant for a different token or network, it could be lost. Exchanges post warnings about this on their deposit addresses so you may have no recourse if you ignore the warning and deposit USDC to the wrong exchange deposit address anyway.
...
We will not be able to assist to recover USDC if you have any problems with an exchange; in order to recover tokens, you will have to file a support ticket directly with the help desk of the exchange in question.

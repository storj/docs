...
{% tabs %}
{% tab label="CLI Install" %}
Parameters are described in [](docId:KJzDdewgBVcK6rnp0Qho2) section. If you need to specify some parameters like a wallet options you can provide them in the [config.yaml](docId:gDXZgLlP_rcSW8SuflgqS) file as well.

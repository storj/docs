---
description: >-
  Each Access Grant includes only one encryption key, but there are use cases
  where multiple keys are relevant and useful.
---

# When to use different encryption keys

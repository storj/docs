---
description: >-
  Developing applications on Storj DCS require a basic familiarity with the
  basic constructs of the service.
---
...
![](<../.gitbook/assets/Screen Shot 2021-05-06 at 8.25.24 AM.png>)
...
Read more about [Satellites](satellite.md).
...
Read more about the [Satellite Admin Console](../getting-started/satellite-developer-account/).
...
If you're interested in learning more details, please read more about [Encryption](encryption-key/) at your leisure.

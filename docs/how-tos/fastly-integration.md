---
description: >-
  Fastly's CDN platform allows users to distribute their content among the
  Fastly edge cloud service. You can easily configure your buckets on Storj as a
  source of content and integrate them with Fastly
---
...
* When you get to the **Hosts** section on the **Origins** page, enter the address of the [Storj gateway endpoint](../api-reference/s3-compatible-gateway/#regions-and-points-of-presence) you would like to use for this service. Include the name of your bucket, for example: `mybucket.gateway.us1.storjshare.io`
...
To integrate your S3 compatible gateway as an origin with Fastly, first [create an access grant](../getting-started/quickstart-uplink-cli/uploading-your-first-object/create-first-access-grant.md). You will need the **Access key** and **Secret key**, as well as your bucket name.

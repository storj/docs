...
const styles = {
  ...
  secondary:
    'rounded-lg bg-slate-800 py-3 px-5 text-sm font-bold text-white hover:bg-slate-700 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/50 active:text-slate-400',
}
